...
export default class StartMatchDialog extends Component {
  constructor(props) {
    ...
    this.updateObjectIndex = this.updateObjectIndex.bind(this);
  }
  ...
  render() {
    ...
    const starting_object = ["YES", "NO"];
    const { position, level, object } = this.state;
    return (
      <View>
        <Dialog
        ...
        >
          <DialogContent>
            ...
            <ButtonGroup
              ...
              containerStyle={{ height: 50 }}
            />
            <Text>Does the robot have a game object?</Text>
            <ButtonGroup
              onPress={this.updateObjectIndex}
              selectedIndex={object}
              buttons={starting_object}
              containerStyle={{ height: 50 }}
            />
          </DialogContent>
        </Dialog>
